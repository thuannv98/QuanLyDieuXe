...
namespace test_web.Controllers
{
    public class LichDangKyController : Controller
    {
        ...
        public ActionResult DsLichNgayMai()
        {
            ...
            {
                new LichDangKy { DangKyLichChiTiet = new tblDangKyLichChiTiet { SoNguoi = 1, ToaDoDi = "10.832282, 106.778043", ToaDoDen = "10.845966, 106.765224", NoiDi = "48 Đường Tăng Nhơn Phú, Tăng Nhơn Phú B, Quận 9", NoiDen = "30-38 Dân Chủ, Bình Thọ, Thủ Đức", GioDen = new TimeSpan(08, 00, 00), GioVe = new TimeSpan(16, 00, 00), NgayDen = DateTime.Now.AddDays(1).Date, TenNguoiDi="Quang", DangKyLichId = 1, DangKyLichChiTietId=1} },
